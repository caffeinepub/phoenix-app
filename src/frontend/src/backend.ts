...
export class Backend implements backendInterface {
    ...
    async addClassGroup(arg0: ClassGroup): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addClassGroup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addJob(arg0: JobListing): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addOrUpdateChat(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateChat(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteClassGroup(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteClassGroup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getChats(): Promise<Array<ChatConversation>> {
        if (this.processError) {
            try {
    ...
    async getClassGroups(): Promise<Array<ClassGroup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getClassGroups();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
